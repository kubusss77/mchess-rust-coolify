...
pub fn get_legal_moves_queen(piece: Piece, board: &mut Board) -> Vec<Move> {
...
pub fn get_controlled_squares_queen(piece: Piece, board: &mut Board) -> Vec<Control> {
    let file = piece.pos.x;
    let rank = piece.pos.y;
...
pub fn get_pins_queen(piece: Piece, board: &mut Board) -> Vec<Pin> {
    let file = piece.pos.x;
    let rank = piece.pos.y;
